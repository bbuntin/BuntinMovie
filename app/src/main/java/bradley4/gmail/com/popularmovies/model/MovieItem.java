...
public class MovieItem implements Serializable {
    ...
    public void setAdult(String mAdult) {
        this.mAdult = mAdult;
    }
    ...
    public void setGenre_ids(String mGenre_ids) {
    ...
    public void setOriginal_language(String mOriginal_language) {
    ...
    public void setVote_count(String mVote_count) {
